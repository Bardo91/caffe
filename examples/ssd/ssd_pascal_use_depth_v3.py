...
mbox_source_layers = ['conv4_3', 'fc7', 'conv6_2', 'conv7_2', 'conv8_2', 'conv9_2', "convd4_3", "fcd7", "convd6_2", "convd7_2", "convd8_2", "convd9_2"]
...
steps = [8, 16, 32, 64, 100, 300, 8, 16, 32, 64, 100, 300]
#aspect_ratios = [[2], [2, 3], [2, 3], [2, 3], [2], [2]]
aspect_ratios = [[2], [2, 3], [2, 3], [2, 3], [2], [2], [2], [2, 3], [2, 3], [2, 3], [2], [2]]
...
solver_param = {
    ...
    # Test parameters
    'test_iter': [test_iter],
    'test_interval': 2000,                     # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<----------------------------- MIGHT WANT TO MODIFY
    'eval_type': "detection",
    'ap_version': "11point",
