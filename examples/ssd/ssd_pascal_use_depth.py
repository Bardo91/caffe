...
def AddExtraDepthLayers(net, use_batchnorm=True, lr_mult=1):
    ConvBNLayer(net, "data2", "convd1_1", False, True, 64, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd1_1", "convd1_2", False, True, 64, 3, 1, 1, lr_mult=lr_mult)
    net.poold1 = L.Pooling(net.convd1_2, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold1", "convd2_1", False, True, 128, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd2_1", "convd2_2", False, True, 128, 3, 1, 1, lr_mult=lr_mult)
    net.poold2 = L.Pooling(net.convd2_2, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold2", "convd3_1", False, True, 256, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd3_1", "convd3_2", False, True, 256, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd3_2", "convd3_3", False, True, 256, 3, 1, 1, lr_mult=lr_mult)
    net.poold3 = L.Pooling(net.convd3_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold3", "convd4_1", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd4_1", "convd4_2", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd4_2", "convd4_3", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    net.poold4 = L.Pooling(net.convd4_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold4", "convd5_1", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd5_1", "convd5_2", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd5_2", "convd5_3", False, True, 512, 3, 1, 1, lr_mult=lr_mult)        ## Respecto a la VGG faltan las FC layers
    net.poold5 = L.Pooling(net.convd5_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold5", "convd6_1", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd6_1", "convd6_2", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd6_2", "convd6_3", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    net.poold6 = L.Pooling(net.convd6_3, pool=P.Pooling.MAX, kernel_size=2, stride=2)
    ConvBNLayer(net, "poold6", "convd7_1", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd7_1", "convd7_2", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
    ConvBNLayer(net, "convd7_2", "convd7_3", False, True, 512, 3, 1, 1, lr_mult=lr_mult)
...
model_name = "VGG_USE_DEPTH".format(job_name)
...
output_result_dir = "{}/data/VOCdevkit_use_depth/results/VOC2007/{}/Main".format(os.environ['HOME'], job_name)
