...
solver = caffe.SGDSolver(caffe_root + 'examples/ssd/jobs/VGGNet/VOC0712/SSD_300x300/solver.prototxt')
solver.net.copy_from(caffe_root + 'models/VGGNet/VOC0712/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_58.caffemodel')
